    ...
    def samples(self, file_path):
        with open(file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                sent1 = data[2]
                if len(data) > 3: yield sent1, data[3], "1" if data[1] == "A" else "0"
                if len(data) > 4: yield sent1, data[4], "1" if data[1] == "B" else "0"
                if len(data) > 5: yield sent1, data[5], "1" if data[1] == "C" else "0"
